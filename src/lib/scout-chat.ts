...
const ROLE_MAP: Record<ScoutRole, string> = {
  ...
  staff: "Home /staff, Candidates /staff/reports/candidates, Reports & Analytics /staff/reports, Assessment Builder /staff/builder, People & Access /staff/people, Settings /staff/settings, Case Library /staff/case-library, Compare /staff/compare.",
